...
MODULES="common.py texts.py store.py tg_api.py llm.py router.py ingest.py reminders.py reminders_svc.py notes_svc.py agreements.py spend.py gcal.py review.py sysinfo.py fetch.py storage.py knowledge.py meeting.py skill_manifest.py trace.py events.py jobs.py runtime.py self_model.py boss_model.py persona.py converse.py memory_curator.py relationship.py action_truth.py proactive.py pdftext.py wardrobe.py hermes.py scene.py"
