...
NOTE: ANY message where the boss signals he has ARRIVED / come in / entered / is at her door / is now here — however casually phrased, even mixed with a greeting ("я вошёл, привет", "ну вот и я", "I'm in") — is meeting_start with kind=visit (the come-in moment). It starts/joins time together NOW; it is never converse.
